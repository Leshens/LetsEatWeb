...
const Footer = () => {
    return (
      <footer className="bg-teal-250 text-white p-8">
          ...
          <div class="grid grid-cols-3 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      <li class="mb-4">
                          <a href="http:/http://31.179.139.182:690/swagger-ui/index.html#/" class="hover:underline">Let's Eat API</a>
                      </li>
                      <li>
              ...
              <div>
                  ...
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      <li class="mb-4">
                          <a href="https://github.com/Leshens/LetsEatWeb" class="hover:underline ">Github</a>
                      </li>
                      <li>
